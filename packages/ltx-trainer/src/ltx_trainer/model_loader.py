...
class LtxModelComponents:
    ...
    audio_vae_encoder: "AudioVAEEncoder | None" = None
...
def load_model(  # noqa: PLR0913
    ...
    with_audio_processor: bool = False,
    ...
    Args:
        ...
        with_audio_vae_encoder: Whether to load the audio VAE encoder (for preprocessing)
    ...
    # Load audio VAE encoder
    audio_vae_encoder = None
    if with_audio_vae_encoder:
        logger.debug("Loading audio VAE encoder...")
        audio_vae_encoder = load_audio_vae_encoder(checkpoint_path, torch_device, dtype)
    ...
    if with_audio_processor:
        logger.debug("Loading audio processor...")
